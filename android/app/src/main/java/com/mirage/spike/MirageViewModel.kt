...
class MirageViewModel : ViewModel() {
    ...
    private fun invalidateRoute() {
        routePts = emptyList(); lastRoute = null
    ...
    fun buildRoute() {
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                lastRoute = r; routePts = r.points; phase = Phase.READY
    ...
    fun startSim(onStart: () -> Unit) {
        ...
        PlaybackSource.routePoints = r.points
    ...
    fun onStopped() {
        phase = if (lastRoute == null) Phase.IDLE else Phase.READY
    }
}
